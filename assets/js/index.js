...
//   alert('Toplam' + ' ' + result +  ' '  + 'soruyu doğru bildin');
// }
...
function result (){
  document.querySelector('ol').classList.add('solved');
  let total = document.querySelectorAll('.true:checked').length;
  alert('Toplam' + ' ' + total +  ' '  + 'soruyu doğru bildin');
}
